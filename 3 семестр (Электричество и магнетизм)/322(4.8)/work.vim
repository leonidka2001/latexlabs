...
nmap <silent> <NL> :call WinMove('j')
xmap <silent> <NL> :call WinMove('j')
omap <silent> <NL> :call WinMove('j')
...
set errorfile=~/Desktop/latexlabs/3\ семест��\ (Элект��ичество\ и\ магнетизм)/322(4.8)/322.log
set expandtab
...
silent only
silent tabonly
cd ~/Desktop/latexlabs/3\ семестр\ (Электричество\ и\ магнетизм)/322(4.8)
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 56 + 56) / 112)
exe 'vert 2resize ' . ((&columns * 55 + 56) / 112)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
xnoremap <buffer> <silent> <SNR>80_(vimtex-[*) :call vimtex#motion#comment(0,1,1)
xnoremap <buffer> <silent> <SNR>80_(vimtex-[/) :call vimtex#motion#comment(1,1,1)
xnoremap <buffer> <silent> <SNR>80_(vimtex-]*) :call vimtex#motion#comment(0,0,1)
xnoremap <buffer> <silent> <SNR>80_(vimtex-]/) :call vimtex#motion#comment(1,0,1)
...
xnoremap <buffer> <silent> <SNR>80_(vimtex-[M) :call vimtex#motion#environment(0,1,1)
xnoremap <buffer> <silent> <SNR>80_(vimtex-[m) :call vimtex#motion#environment(1,1,1)
xnoremap <buffer> <silent> <SNR>80_(vimtex-]M) :call vimtex#motion#environment(0,0,1)
xnoremap <buffer> <silent> <SNR>80_(vimtex-]m) :call vimtex#motion#environment(1,0,1)
...
xnoremap <buffer> <silent> <SNR>80_(vimtex-[[) :call vimtex#motion#section(0,1,1)
xnoremap <buffer> <silent> <SNR>80_(vimtex-[]) :call vimtex#motion#section(1,1,1)
xnoremap <buffer> <silent> <SNR>80_(vimtex-][) :call vimtex#motion#section(1,0,1)
xnoremap <buffer> <silent> <SNR>80_(vimtex-]]) :call vimtex#motion#section(0,0,1)
...
xnoremap <buffer> <silent> <SNR>80_(vimtex-%) :call vimtex#motion#find_matching_pair(1)
nnoremap <buffer> <silent> <Plug>(vimtex-%) :call vimtex#motion#find_matching_pair()
nnoremap <buffer> <SNR>80_(V) V
nnoremap <buffer> <SNR>80_(v) v
...
let s:l = 81 - ((31 * winheight(0) + 22) / 44)
...
wincmd w
argglobal
if bufexists("322.tex") | buffer 322.tex | else | edit 322.tex | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
imap <buffer> <nowait> <silent> <F7> <Plug>(vimtex-cmd-create)
