...
set errorfile=~/Desktop/latexlabs/3\ семест��\ (Элект��ичество\ и\ магнетизм)/344/344.log
set expandtab
...
silent only
silent tabonly
cd ~/Desktop/latexlabs/3\ семестр\ (Электричество\ и\ магнетизм)/344
...
tabnew
tabrewind
edit ~/Desktop/latexlabs/3\ семестр\ (Электричество\ и\ магнетизм)/322(4.8)/322.tex
...
wincmd w
argglobal
if bufexists("344.tex") | buffer 344.tex | else | edit 344.tex | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
imap <buffer> <nowait> <silent> <F7> <Plug>(vimtex-cmd-create)
...
badd +9 ~/Desktop/latexlabs/3\ семестр\ (Электричество\ и\ магнетизм)/322(4.8)/322.tex
